   ...
   <section class="slider">
      <ul class="slidr-carousel" id="slidr-carousel">
          <li class="img1">
              ...
              <a href="login.php" class="btn btn-half">SIGN UP</a>
          </li>
           <li class="img2">
              <h2>Happy <span>Pet</span> Care</h2>
     ...
     <div class="img3">
      <div class="container">
        ...
        <div class="col-md-3 text-center tx">
          ...
          <h3><a href="#slidr-carousel">Pet for Sale</a></h3>
        ...
        <div class="col-md-3 text-center tx">
          <div class="icon">
            ...
            <h3><a href="#slidr-carousel">Pet Food</a></h3>
        ...
        <div class="col-md-3 text-center tx">
          <div class="icon">
            ...
            <h3><a href="#slidr-carousel">Product</a></h3>
        ...
        <div class="col-md-3 text-center tx">
          <div class="icon">
            ...
            <h3><a href="project/medicle/medicle.php">Health Care</a></h3>
                ...
                <div class="contact-block">
                   ...
                   <form class="form-container">
                       <div class="row">
                           ...
                           <div class="col-sm-6">
                               <div class="form-group">
                                   <textarea class="font-control" ></textarea>
                               </div>
                               <div class="form-group">
                                   <input type="submit" style="color:coral;" class="btn default-btn btn-block" value="Submit Quries">
                               </div>
                           </div>
                       </div>
                   </form>
